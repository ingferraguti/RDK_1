      ...
      <div className={classes.list}>
        ...
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/blocks">
            <ListItem button key="Block">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Block" />
            </ListItem>
          </Link>{" "}            
           <Link to="/blocktypes">
            <ListItem button key="BlockType">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="BlockType" />
            </ListItem>
          </Link>{" "}            
           <Link to="/items">
